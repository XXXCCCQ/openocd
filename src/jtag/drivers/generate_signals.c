...
//                 if(!checkExistence(fp,"TDI Out;TMS Out;TCK Out")){
//                     fprintf(fp,"  TDI Out;TMS Out;TCK Out\n");
//                     }
//                 if(!checkExistence(fp,"TDO In")){
//                     fprintf(fp,"  TDO In;\n");
//                     }
...
//         }
//     }
//     if(!checkExistence(fp,"BBUS='TDI+TCK+TMS'")){
//         if(checkExistence(fp,"TDI")){
//             fprintf(fp,"    BBUS='TDI+TCK+TMS';\n");
//         }
//     }
...
//         switch(commands[1]){
//             case STLINK_DEBUG_WRITEMEM_32BIT:  
// 				size = (uint16_t)(commands[6]) | ((uint16_t)(commands[7]) << 8); 
//                 fprintf(fp, "    TDI="); // tdi 
...
//                 break;
//             case STLINK_DEBUG_APIV2_SWD_SET_FREQ:
//                 size = (uint16_t)(commands[2]) | ((uint16_t)(commands[3]) << 8); 
//                 fprintf(fp, "    TDO=");  //tdo
//                 for (uint32_t i = 0; i < size; i++)
//                 {
//                     if ((xfer_in[i / 8] >> (7 - (i % 8))) & 1)
...
//     generate_patternsignals(fp,transfers[1].buf,transfers);
//         //         break;
